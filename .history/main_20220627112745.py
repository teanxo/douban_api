...
def playDetail():
  ...
  # 评分
  # resp['rating'] = content.find_element(By.XPATH, '//*[@class="rating_wrap"]').find_element(By.CLASS_NAME, 'rating_self').find_element(By.CLASS_NAME,'rating_num').text

  # 内容简介
  resp['content_intro'] = content.find_element(By.XPATH, '//*[@class="indent"]').find_element(By.TAG_NAME).text
