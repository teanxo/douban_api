...
def playDetail():
  ...
  # 评分
  resp['rating'] = content.find_element(By.XPATH, '//*[@id="interest_sectl"]').find_element(By.CLASS_NAME, 'rating_wrap').find_element(By.CLASS_NAME, 'rating_self').find_element(By.CLASS_NAME, 'rating_num')
